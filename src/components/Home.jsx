        ...
        {isLoading && (
          ...
          >
            <motion.div
              ...
              className="mb-8"
            >
              <img src={logo} alt="EDURWANDA Logo" className="h-20 w-20" />
            </motion.div>
              ...
              <div className="w-full lg:w-1/2 lg:pr-10 mb-10 lg:mb-0">
                <div className="text-center lg:text-left">
                  <motion.div 
                    ...
                    transition={{ delay: isLoading ? 1 : 0.2, type: "spring" }}
                  ...
                  <motion.h1 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: isLoading ? 1.2 : 0.4 }}
                  ...
                  >
                    ...
                    <motion.span 
                      ...
                      transition={{ delay: isLoading ? 1.4 : 0.6 }}
                  ...
                  <motion.p 
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ delay: isLoading ? 1.6 : 0.8 }}
                  ...
                  <motion.div 
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ delay: isLoading ? 1.8 : 1 }}
              ...
              <div className="w-full lg:w-1/2 lg:pl-10 flex justify-center">
                <picture>
                  ...
                  <motion.img 
                    ...
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ delay: isLoading ? 1.4 : 0.6, duration: 0.8 }}
                    whileHover={{ 
                      y: -10,
                      transition: { 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {stats.map((stat, index) => (
                ...
                >
                  <motion.div 
                    className="flex justify-center text-3xl mb-3"
                  ...
                  <motion.div 
                    className="text-sm sm:text-base text-green-600 mt-1"
        ...
        <section className="py-10 sm:py-16 bg-white" ref={ref}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.p 
                className="mt-3 max-w-2xl mx-auto text-base sm:text-lg text-gray-500"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {courses.map((course, index) => (
                ...
                >
                  <motion.div 
                    className="h-40 sm:h-48 bg-green-100 flex items-center justify-center relative overflow-hidden"
                    whileHover={{ 
                      scale: 1.05,
                      transition: { duration: 0.3 }
                    }}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <motion.div 
                    className="absolute -top-10 -right-10 w-20 h-20 bg-green-100 rounded-full opacity-20"
                    animate={{
                      x: [0, 5, 0],
                      y: [0, -5, 0],
                      transition: {
                  ...
                  ></motion.div>
                  <motion.div 
                    className="absolute -bottom-10 -left-10 w-24 h-24 bg-green-100 rounded-full opacity-20"
                    animate={{
                      x: [0, -5, 0],
                      y: [0, 5, 0],
                      transition: {
        ...
        <section className="py-10 sm:py-16 relative overflow-hidden">
          ...
          >
            <motion.div 
              ...
              animate={{
                background: [
                  "linear-gradient(45deg, #d1fae5, #a7f3d0, #6ee7b7, #34d399, #10b981, #059669)",
                  "linear-gradient(135deg, #d1fae5, #a7f3d0, #6ee7b7, #34d399, #10b981, #059669)",
                  "linear-gradient(225deg, #d1fae5, #a7f3d0, #6ee7b7, #34d399, #10b981, #059669)",
                  "linear-gradient(315deg, #d1fae5, #a7f3d0, #6ee7b7, #34d399, #10b981, #059669)",
                  "linear-gradient(45deg, #d1fae5, #a7f3d0, #6ee7b7, #34d399, #10b981, #059669)"
                ],
                transition: {
                  duration: 15,
